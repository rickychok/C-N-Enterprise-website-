            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-black">Advanced Equipment</h3>
                    <p className="text-black">State-of-the-art diagnostic tools and oscilloscopes to identify complex electrical issues.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-3 mr-4 flex-shrink-0 border border-yellow-700"></div>
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-black">Circuit Analysis</h3>
                    <p className="text-black">Complete electrical circuit tracing and analysis to locate faults and shorts.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-3 mr-4 flex-shrink-0 border border-yellow-700"></div>
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-black">Wiring Harness Repair</h3>
                    <p className="text-black">Professional repair and replacement of damaged wiring harnesses and connectors.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-3 mr-4 flex-shrink-0 border border-yellow-700"></div>
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-black">System Optimization</h3>
                    <p className="text-black">Electrical system optimization for improved performance and reliability.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-black">Systematic approach to electrical problem solving</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">Initial Assessment</h3>
              <p className="text-black">Comprehensive evaluation of symptoms and electrical system overview.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">Advanced Testing</h3>
              <p className="text-black">Using diagnostic equipment to pinpoint electrical faults and issues.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">Repair & Replace</h3>
              <p className="text-black">Professional repair of identified issues using quality components.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">System Verification</h3>
              <p className="text-black">Complete system testing to ensure all functions work properly.</p>
            </div>
          </div>
        </div>
      </section>
