...
// Note: This component is client-side because it handles form interactions
// In a real implementation, you would handle metadata differently for client components
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get in touch with our automotive electrical experts. We&apos;re here to help with all your electrical repair needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href={getPhoneUrl()}
                className="border-2 border-yellow-500 text-yellow-500 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-yellow-500 hover:text-black active:scale-95 hover:scale-105 transition-all duration-200"
              >
                Call Now
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <div className="space-y-1">
                <a href={getPhoneUrl()} className="text-yellow-600 font-semibold hover:text-yellow-500 block">
                  011-18696757 (Main)
                </a>
                <a href="tel:016-8305277" className="text-yellow-600 font-semibold hover:text-yellow-500 text-sm block">
                  016-8305277
                </a>
                <a href="tel:016-8305668" className="text-yellow-600 font-semibold hover:text-yellow-500 text-sm block">
                  016-8305668
                </a>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-1">
                <a 
                  href={getWhatsAppUrl('Hi, I need automotive electrical service help')}
                  className="text-yellow-600 font-semibold hover:text-yellow-500 block"
                >
                  011-18696757 (Main)
                </a>
                <span className="text-gray-500 text-sm block">Also available: 016-8305277, 016-8305668</span>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <a
                ...
                className="text-yellow-600 font-semibold hover:text-yellow-500 break-all"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 mb-8">
                Fill out the form below and we&apos;ll contact you via WhatsApp to discuss your automotive electrical needs.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-500 text-black px-8 py-4 rounded-lg text-lg font-semibold hover:bg-yellow-400 active:scale-95 hover:scale-105 transition-all duration-200"
                >
                  Send via WhatsApp
                </button>
              </form>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8 border border-gray-200">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800 font-medium">8:00 AM - 2:00 PM</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                <h3 className="font-semibold text-lg mb-3 text-yellow-800">Emergency Service</h3>
                <p className="text-yellow-700">
                  For urgent electrical issues that leave you stranded, contact us via WhatsApp anytime. 
                  We&apos;ll do our best to provide emergency assistance or guidance.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700 mb-6">
              Visit us at our workshop in Taman Hing Wah, Sandakan. We're conveniently located for easy access.
            </p>
          </div>
          
          <div className="bg-white rounded-lg border-2 border-gray-200 shadow-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.015068!2d118.1165!3d5.8369!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwNTAnMTIuOCJOIDExOMKwMDYnNTkuNCJF!5e0!3m2!1sen!2smy!4v1"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="C&N Enterprise Location Map"
              className="w-full"
            />
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-semibold text-gray-900">C&N Enterprise</p>
                  <p className="text-sm text-gray-600">Ground Floor, Shop House No 4, MDLB 1633, Taman Hing Wah</p>
                  <p className="text-sm text-gray-600">Batu 8 Jalan Labuk, Sandakan, Sabah</p>
                </div>
                <a
                  href="https://www.google.com/maps/dir//5.8369,118.1165"
                  target="_blank"
